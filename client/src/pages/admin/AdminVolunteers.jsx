    ...
    <AdminLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          {/* 👇 FIXED BUTTON: Removed DialogTrigger, used simple onClick */}
                    ...
                    <TableRow key={volunteer._id}>
                      ...
                      <TableCell className="text-right">
                        ...
                        <Button
                          ...
                          onClick={() => {
                            if(confirm('Are you sure? This will delete the volunteer account.')) {
                              deleteMutation.mutate(volunteer._id)
                            }
                          }}
                        >
