...
export default function About() {
  const stats = [
    { label: "Community Members", value: "1,000+", icon: Users, color: "text-blue-400" },
    { label: "Events Hosted", value: "10+", icon: Calendar, color: "text-purple-400" },
    { label: "Expert Speakers", value: "20+", icon: Trophy, color: "text-amber-400" },
    { label: "Projects Built", value: "50+", icon: Code2, color: "text-emerald-400" },
  ];
  ...
  return (
    ...
    <Navbar />
      ...
      <div className="fixed top-0 left-1/4 w-96 h-96 bg-primary/20 rounded-full blur-[100px] pointer-events-none -z-10" />
      <div className="fixed bottom-0 right-1/4 w-96 h-96 bg-purple-500/10 rounded-full blur-[100px] pointer-events-none -z-10" />
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        ...
        <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-black">
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {stats.map((stat, index) => (
            <Card key={index} className="glass border-border/50 text-center py-6 hover:border-primary/50 transition-colors">
              <CardContent className="p-0">
                <div className={`mx-auto w-12 h-12 rounded-full bg-background/50 flex items-center justify-center mb-4 ${stat.color}`}>
      ...
      <section className="container mx-auto px-4 py-24">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="absolute -inset-4 bg-gradient-to-r from-primary to-purple-600 rounded-xl blur-lg opacity-30" />
            <img 
