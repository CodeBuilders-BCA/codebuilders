...
const EventDetail = () => {
  ...
  // ✅ 1. SIDEBAR COMPONENT (Reusable for Mobile & Desktop)
  const EventSidebar = () => (
        ...
        <div className="space-y-6 mb-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              {/* ✅ Dynamic Map Link */}
              {event.mapUrl ? (
                <a href={event.mapUrl} target="_blank" rel="noopener noreferrer" className="text-muted-foreground text-sm hover:text-primary hover:underline transition-colors flex items-center gap-1">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid lg:grid-cols-12 gap-8 md:gap-12">
            ...
            <div className="lg:col-span-8 space-y-10">
              ...
              {/* ✅ 2. MOBILE ONLY SIDEBAR (Placed HERE) */}
            ...
            {/* ✅ 3. DESKTOP ONLY SIDEBAR (Right Column) */}
